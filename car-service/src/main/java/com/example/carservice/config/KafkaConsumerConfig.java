...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, BookingCreatedEvent> bookingCreatedConsumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.common.dtos.kafka");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.example.common.dtos.kafka.BookingCreatedEvent");
